<template>
  <div
    class="min-h-[100dvh] bg-gray-50 flex justify-center items-center p-0 sm:p-4"
  >
    <div
      class="w-full max-w-md bg-white min-h-[100dvh] sm:min-h-0 sm:h-auto sm:rounded-[3rem] shadow-xl relative overflow-hidden flex flex-col px-8 py-12 justify-center"
    >
      ...
      ></div>
      <div
        class="absolute bottom-10 -left-20 w-80 h-80 bg-primary/5 rounded-full blur-3xl"
      ></div>
        ...
        <div class="space-y-5">
          <div class="space-y-1.5">
            ...
            <div class="relative group">
              <MailIcon
                :size="20"
                class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-primary transition-colors"
              />
              <input
                v-model="email"
                type="email"
